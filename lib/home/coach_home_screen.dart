...
class _CoachHomeScreenState extends State<CoachHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pages = [_CoachCoursesTab(coachId: uid), _CoachProgramsTab()];
    ...
    return InkWell(
      onTap:
          () => Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => _CourseAttendeesScreen(course: course),
            ),
          ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${dateFmt.format(course.schedule)} · ${timeFmt.format(course.schedule)}',
                    style: const TextStyle(
                      fontSize: 12,
                      color: AppColors.textSecondary,
                    ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Salle ${course.room} · ${course.durationMin} min',
                        style: const TextStyle(
                          fontSize: 12,
                          color: AppColors.textHint,
                        ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Membre ${booking.userId.substring(0, 6)}...',
                  style: const TextStyle(
                    fontSize: 13,
            ...
            children: [
              IconButton(
                icon: Icon(
                  ...
                  color: isAttended ? AppColors.green : AppColors.textHint,
                  size: 24,
                ),
              ...
              IconButton(
                icon: Icon(
                  ...
                  color: isAbsent ? AppColors.red : AppColors.textHint,
                  size: 24,
                ),
